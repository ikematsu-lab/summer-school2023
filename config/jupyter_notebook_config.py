...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$sgBoCaRHFqujuG3dN6XOsw$x8uMiElhF4ENVqAcR7gYOHSp8c+pJ1hhWnw4e5pIOAk'
...
#  Choices: any of ['sha224', 'sha256', 'sha3_512', 'blake2s', 'blake2b', 'sha3_384', 'md5', 'sha512', 'sha1', 'sha3_224', 'sha384', 'sha3_256']
#  Default: 'sha256'
